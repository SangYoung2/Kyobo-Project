...
public class AdminController {
    ...
    public void upload_book_data(UploadBookDTO uploadBookDTO){
        ...
        save_book_data(uploadBookDTO.getMainImageFile(), uploadBookDTO.getContentsImageFile(), bookVO.getISBN());
    }

    private void save_book_data(MultipartFile mainImageFile, MultipartFile contentsImageFile , String dirName) {
